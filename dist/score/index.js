 ...
 */
export async function scoreTrajectory(path, _targetCenterX, _targetCenterY, _targetRadius) {
 ...
 */
export async function measureAndScore(path, _targetCenterX, _targetCenterY, _targetRadius) {
